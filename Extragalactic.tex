...
\caption{Fractional difference between the standard deviation $\sigma\sub{SD}$ and the $68$-percentile half-width $\sigma_{0.68}$ of the marginalised posterior for $\ln(M/M_\odot)$ as a function of periapsis for bursts from M32. The filled circles are converged runs and the open circles for those yet to converge.\label{fig:sigma-ratio-mass}}
\end{center}
\end{figure}
