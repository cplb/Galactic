...
%\begin{minipage}{\columnwidth}
 \centering
  ...
  \hline
   Galaxy & \multicolumn{3}{c}{$M/10^6 M_\odot$} & \multicolumn{1}{c}{$R/\mathrm{Mpc}$} & References \\
 \hline
...
Having recovered the posterior distribution it is necessary to quantify the accuracy to which parameters could be measured. If the posterior were Gaussian, this can be done just by using the standard deviation. An alternative wis to use the range that encloses a given probability, but this is misleading if the distribtuion is multimodal. A robust means of characterising the width is by using a $k$-d tree.

\section{Results}

\begin{figure*}
\begin{center}
\subfigure[Natural logarithm of MBH mass.]{\includegraphics[width=0.42\textwidth]{Fig_M32_MCMC_sigmas_rp_6}} \quad
\subfigure[Dimensionless spin.]{\includegraphics[width=0.43\textwidth]{Fig_M32_MCMC_sigmas_SNR_6}} \\
...
\begin{figure*}
\begin{center}
\subfigure[Natural logarithm of MBH mass.]{\includegraphics[width=0.42\textwidth]{Fig_N4945_MCMC_sigmas_rp_6}} \quad
\subfigure[Dimensionless spin.]{\includegraphics[width=0.43\textwidth]{Fig_N4945_MCMC_sigmas_SNR_6}} \\
...
\begin{figure*}
\begin{center}
\subfigure[Natural logarithm of MBH mass.]{\includegraphics[width=0.42\textwidth]{Fig_N4395_MCMC_sigmas_rp_6}} \quad
\subfigure[Dimensionless spin.]{\includegraphics[width=0.43\textwidth]{Fig_N4395_MCMC_sigmas_SNR_6}} \\
\contcaption{Distribution widths as functions of periapsis $r\sub{p}$ for NGC 4945. Light blue is used for the standard deviation, orange is the $68$-percentile half-width calculated from the $k$-d tree. Filled circles are used for converged runs, open circles for those yet to converge. The dotted line indicates the current uncertainty for $M$; the dashed lines the standard deviation for an uninformative prior, and the solid line the total prior range.}
\end{center}
\end{figure*}
