...
There is possibly some subtly dependence upon inclination that is being lost under the noise of the intrinsic scatter.
...
Two energy spectra are plotted in \figref{Energy} for orbits with a periapses of $r\sub{p} = 7.5 r\sub{S}$, $15.0 r\sub{S}$ and $30.0 r\sub{S}$.\begin{figure*}
  \begin{center}
  ...
  \end{center}
\end{figure*}
The two spectra appear to be in good agreement, showing the same general shape in the weak-field limit. The NK spectrum is more tightly peaked, but is always within a factor of $2$ at the apex.
