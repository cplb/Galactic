...
Two energy spectra are plotted in \figref{Energy} for orbits with a periaps3s of $r\sub{p} = 30.0 r\sub{S}$ and $r\sub{p} = 30.0 r\sub{S}$.\begin{figure*}
  \begin{center}
   \subfigure[$r\sub{p} = 30.0 r\sub{S}$, log-log plot.]{\includegraphics[width=0.45\textwidth]{Fig_Loglog_E_30}} \quad
   \subfigure[$r\sub{p} = 30.0 r\sub{S}$, log-linear plot.]{\includegraphics[width=0.45\textwidth]{Fig_Loglin_E_30}} \\
   \subfigure[$r\sub{p} = 60.0 r\sub{S}$, log-log plot.]{\includegraphics[width=0.45\textwidth]{Fig_Loglog_E_60}} \quad
   \subfigure[$r\sub{p} = 60.0 r\sub{S}$, log-linear plot.]{\includegraphics[width=0.45\textwidth]{Fig_Loglin_E_60}}
