...
\begin{figure*}
  \begin{center}
   ...
   \contcaption{(Continued) Mass-normalised parameter uncertainties and SNR. The points represent the entire set of data. The lines are maximum likelihood fits to the values obtained by averaging over each set of intrinsic parameters. See \tabref{lines} for best fit parameters.}
    \label{fig:sigmas}
  \end{center}
\end{figure*}
...
\begin{minipage}{\columnwidth}
 ...
 \hline
 $X$ & Extrinsic parameter & $A_1$ & $B_1$ & $A_2$ & $B_2$ & $\chi^2/\nu$\\
 \hline
 $\hat{\sigma}_{M_\bullet}/\left(10^6 M_\odot^2\right)$ & -- & \\
 $\hat{\sigma}_{a_\ast}/M_\odot$ & $a_\ast = 0.0$ & \\
  & $a_\ast = 0.3$ & \\
  & $a_\ast = 0.6$ & \\
  & $a_\ast = 0.9$ & \\
 $\hat{\sigma}_\Theta/M_\odot$ & -- & \\
 $\hat{\sigma}_\Psi/M_\odot$ & -- & \\
 $\hat{\sigma}_{\ln R_0}/M_\odot$ & -- &\\
 $\hat{\sigma}_{\overline{\Theta}}/M_\odot$ & -- & \\
 $\hat{\sigma}_{\overline{\Phi}}/M_\odot$ & -- & \\
 $\hat{\sigma}_{L_z}/\left(G M_\bullet c^{-1} M_\odot\right)$ & $\iota = \pi/12$ & \\
  & $\iota = \pi/4$ & \\
  & $\iota = 5\pi/12$ & \\
 $\hat{\sigma}_Q/\left(G^2 M_\bullet^2 c^{-2}M_\odot\right)$ & $\iota = \pi/12$ & \\
  & $\iota = \pi/4$ & \\
  & $\iota = 5\pi/12$ & \\
 $\hat{\sigma}_\mu/\mu$ & -- & \\
 $\hat{\sigma}_{x_0}/\left(5 \times 10^5 r_\mathrm{S} M_\odot\right)$ & -- & \\
 $\hat{\sigma}_{y_0}/\left(5 \times 10^5 r_\mathrm{S} M_\odot\right)$ & -- & \\
 $\hat{\sigma}_{z_0}/\left(5 \times 10^5 r_\mathrm{S} M_\odot\right)$  & $\iota = \pi/12$ & \\
  & $\iota = \pi/4$ & \\
  & $\iota = 5\pi/12$ & \\
 \hline
 \end{tabular}
