...
There exists a correltation between the periapse radius and SNR, as shown in \figref{SNR}. Closer orbits produce louder bursts. The straight line is a maximum likelihood fit assuming that the SNR has a Gaussian distribtion with standard deviation derived from the scatter of points. The parameter uncertainties are well correlated with the SNR. Some are sensitive to other parameters, such as the MBH spin, or the orbital inclination.
