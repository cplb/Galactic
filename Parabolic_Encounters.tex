...
The authors are indebted to Michele Vallisneri for useful discussions on the proper use of Fisher matrices, and are grateful to Dave Green for helpful suggestions regarding apodization. CPLB is supported by STFC. JRG is supported by the Royal Society.
