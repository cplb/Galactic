...
\item[(6, 7)] The angular momentum of the compact object. This can be described using either $\{L_z, Q\}$ or $\{L_\infy, \iota\}$. We will employ the latter, as the total angular momentum and inclination as less tightly correlated. Assuming spherical symmetry, we $\cos \iota$ expect be uniformly distributed.
\item[(8--11)]         The initial position of the particle $(r_0, \theta_0, \phi_0)$. For specific values of $Q$ and $L_z$ there is a definite upper limit on $\theta_0$ given by \eqnref{theta_0}.
