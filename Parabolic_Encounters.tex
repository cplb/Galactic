...
\caption{Parameter standard deviations as functions of periapsis $r\sub{p}$ showing dependence (or lack thereof) upon the spin magnitude $|a_ast|$.}
...
The spin is less well understood. To obtain an uncertainty of $0.1$, comparable to that achieved in X-ray measurements of active galactic nuclei, it appears that the periapsis needs to be $r\sub{p} \lesssim 11 r\sub{g}$. For smaller periapses, the uncertainty can be much smaller, indicating that an EMRB could be an excellent probe.
