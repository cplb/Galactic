...
\begin{equation}
\overline{\tau\sub{R}} \simeq 3.1 \tau\sub{R}\super{Max}.
\end{equation}
...
\begin{equation}
\overline{\tau\sub{R,\,MS}} \simeq 2.6 \tau\sub{R}\super{Max};\quad \overline{\tau\sub{R,\,WD}} \simeq 2.5 \tau\sub{R}\super{Max}; \overline{\tau\sub{R,\,NS}} \simeq 3.2 \tau\sub{R}\super{Max}.
\end{equation}
