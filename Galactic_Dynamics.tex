...
\begin{figure*}
\begin{center}
   %\subfigure[{Main sequence stars.}]{\includegraphics[width=0.45\textwidth]{}}
\caption{Inner cut-off radii for the Galactic Centre as a function of eccentricity.\label{fig:Cuts}}
  \end{center}
\end{figure}
