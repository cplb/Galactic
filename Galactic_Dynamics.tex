...
where
\begin{align}
\beta(w;p) = {} & \begin{cases} \dfrac{9\sqrt{\pi}\Gamma(1+p)}{2(1-2p)\Gamma(p + 7/2)} - \dfrac{9\Beta\left(3 - p, 1 + p\right)}{(1-2p)(2-p)}\left(\dfrac{v_2^2}{2\sigma^2}\right)^{p-1/2} & p < \recip{2} \\
