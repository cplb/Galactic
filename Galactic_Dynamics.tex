...
We will be using the Fokker-Planck model of Hopman and Alexander~\cite{Hopman2006, Hopman2006a, Hopman2009}. This includes four stellar species: main sequence stars (MS), white dwarfs (WD), neutron stars (NS), and black holes (BH). Their properties are summarised in \tabref{HA}.
\begin{table*}
 \centering
