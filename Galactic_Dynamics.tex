...
\begin{minipage}{\columnwidth}
 \centering
  ...
  \begin{tabular}{@{} l D{,}{\times}{3.4} D{,}{\times}{3.4} D{.}{.}{1.1} D{.}{.}{1.3} @{}}
  \hline
   Star & \multicolumn{1}{c}{$\mathcal{N}_2\super{int}$} & \multicolumn{1}{c}{$\mathcal{N}_2\super{run}$} & \multicolumn{1}{c}{$p_M$} & \multicolumn{1}{c}{$k_M/k_\star$\footnote{\citet*{Toonen2009}}} \\
 \hline
 MS & 6.4,10^{-4} & 1 & -0.1 & 1 \\
 WD & 3.7,10^{-4} & -0.1 & 0.09 \\
 NS & 2.5,10^{-1} & 0.0 & 0.01  \\
 BH & 5.8,10^{-1} & 0.5 & 0.008 \\
\hline
\end{tabular}
\end{minipage}
\end{table}
