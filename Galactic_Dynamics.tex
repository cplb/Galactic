...
Evaluating the formulae for average relaxation time-scales with values appropriate for the Galactic centre (\secref{GC_Param}) provides some insight. Comparison of the system relaxation time-scales with that evaluated using a Maxwellian distribution [\eqnref{tauMaxwell}, using $\kappa = 0.34$] shows a broad consistency:
\begin{equation}
