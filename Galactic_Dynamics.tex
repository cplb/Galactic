...
\overline{\Delta E^2\sub{b,2}} = {} & 4\pi\intd{0}{\infty}{\Delta E^2\sub{b} v^2 p_{\mathrm{b},2}(v)}{v} \\
 \approx {} & \frac{32}{3}\frac{G^2m_1^2m_2^2n_\ast}{\sigma^2}\ln\left(\Lambda\right) k \frac{(3/2 - p_2)\Gamma(p_2 + 7/2)}{\Gamma(p_2 + 1)} \nonumber \\* 
 {} & \times \left[ \intd{0}{\sqrt{2}\sigma}{v^2\left(\frac{v^2}{2\sigma^2}\right)^{p_2-2} \frac{3}{(2 - p_1)(1 + p_1)} {_3F_2}\left(-1-p_1,2-p_1,\frac{3}{2};3-p_1,\frac{5}{2};\frac{v^2}{2\sigma^2}\right) \Beta\left(\frac{v^2}{2\sigma^2};3-p_2,1+p_2\right)}{v} \right. \nonumber \\* 
...
\begin{align}
\overline{\Delta E^2\sub{b,2}} \approx {} & \frac{32}{3}\frac{G^2m_1^2m_2^2n_\ast}{\sigma^2}\ln\left(\Lambda\right) k \frac{(3/2 - p_2)\Gamma(p_2 + 7/2)}{\Gamma(p_2 + 1)} \left[ \frac{30 + 36p_1 + 25p_1^2 - p_2\left(13 + 15p_1 + 7 p_1^2\right) + p_2^2\left(6 + 9p_1 + 8p_1^2\right)}{210} \right. \nonumber \\* 
 {} & + \left. \vphantom{\frac{30 + 36p_1 + 25p_1^2 - p_2\left(13 + 15p_1 + 7 p_1^2\right) + p_2^2\left(6 + 9p_1 + 8p_1^2\right)}{210}} \iota \left(p_1,p_2\right) \right] \delta t,
\end{align}
introducing
\begin{equation}
\iota\left(p_1,p_2\right) = \Beta\left(3-p_2,1+p_2\right) \begin{cases} \dfrac{3}{1/2 - p}\left[\dfrac{\Beta\left(5/2,1+p_1\right)}{2-p_2} - \dfrac{3\Beta\left(3-p_1,1+p_1\right)}{2\left(2-p_1\right)\left(5/2 - p_1 - p_2\right)}\right] & p_1 < \recip{2} \\
