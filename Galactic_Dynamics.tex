...
\begin{align}
\Delta E^2 \approx {} & \frac{8}{3}\sqrt{2\pi}\frac{G^2m_1^2 m_2^2n_\ast}{\sigma^3}\ln qv_2^2\left\{\intd{0}{v_2}{3k\frac{v_1^4}{v_2}\left(\frac{v_1^2}{2\sigma^2}\right)^{p-3} \Beta\left(\frac{v_1^2}{2\sigma^2};3 - p, 1 + p\right)}{v_1} \right. \nonumber\\*
 ...
 & + \left. \intd{\sqrt{2}\sigma}{\infty}{v_1v_2^2\left[k\left(\frac{v_1^2}{2\sigma^2}\right)^{p-3}\frac{\Gamma(3 - p_M)\Gamma(1 + p_M)}{2} + C\epsilon\left(\frac{v_1^2}{2\sigma^2}\right)\right]}{v_1}\right\}\,\delta t,
\end{align}
...
\begin{align}
\Delta E^2 \approx {} & \frac{16}{3}\sqrt{2\pi}\frac{G^2m_1^2 m_2^2n_\ast}{\sigma^3}\ln qv_2^2 \frac{v_2^2}{2\sigma^2} \left\{k\left[\frac{12}{5(1 - 2p)}\frac{v_2^2}{2\sigma^2} {_2F_1}\left(\frac{5}{2},-p;\frac{7}{2};\frac{v_2^2}{2\sigma^2}\right) \right.\right. \nonumber\\*
 & - \left.\left. \frac{9}{(2-p)(1-2p)}\left(\frac{v_2^2}{2\sigma^2}\right)^{p-2}\Beta\left(\frac{v_2^2}{2\sigma^2};3-p,1-p\right) + \frac{3}{(2-p)(1+p)}\left(1 - \frac{v_2^2}{2\sigma^2}\right)^(1+p)\right] + C\right\}\,\delta t,
\end{align}
...
\begin{align}
\Delta E^2 \approx {} & \frac{8}{3}\sqrt{2\pi}\frac{G^2m_1^2 m_2^2n_\ast}{\sigma^3}\ln qv_2^2\left\{\intd{0}{\sqrt{2}\sigma}{3k\frac{v_1^4}{v_2}\left(\frac{v_1^2}{2\sigma^2}\right)^{p-3} \Beta\left(\frac{v_1^2}{2\sigma^2};3 - p, 1 + p\right)}{v_1} \right. \nonumber\\*
 & + \left. \intd{\sqrt{2}\sigma}{v_2}{\frac{v_1^4}{v_2}\left[k\left(\frac{v_1^2}{2\sigma^2}\right)^{p-3}\frac{\Gamma(3 - p_M)\Gamma(1 + p_M)}{2} + C \epsilon\left(\frac{v_1^2}{2\sigma^2}\right)\right]}{v_1} \right. \nonumber\\*
 & \left. + \intd{v_2}{\infty}{v_1v_2^2\left[k\left(\frac{v_1^2}{2\sigma^2}\right)^{p-3}\frac{\Gamma(3 - p)\Gamma(1 + p)}{2} + C \epsilon\left(\frac{v_1^2}{2\sigma^2}\right)\right]}{v_1}\right\}\,\delta t.
\end{align}
...
\begin{align}
\Delta E_b^2 \approx {} & 16\sqrt{2\pi}G^2m_1^2m_2^2n_\ast\sigma\ln qv_2^2 k \left\{\left[1 + \left(\frac{v_2^2}{2\sigma^2}\right)^4\right]^{-1}\left[\frac{3}{(1 + p)(2 - p)} - \frac{9}{5(3-p)}\frac{v_2^2}{2\sigma^2} + \frac{9p}{14(7-p)}\left(\frac{v_2^2}{2\sigma^2}\right)^2 \right.\right. \nonumber\\*
 & + \left.\left. \frac{p(1-p)}{6(5-p)}\left(\frac{v_2^2}{2\sigma^2}\right)^3 \right] + \recip{1 - 2p}\left(\frac{v_2^2}{2\sigma^2}\right)^{7/2}\left[1 + \left(\frac{v_2^2}{2\sigma^2}\right)^4\right]^{-1}\left[\frac{9\sqrt{\pi}\Gamma(1+p)}{2\Gamma(p + 7/2)} - \frac{3\Gamma(3 - p)\Gamma(1 + p)}{2(2-p)}\left(\frac{v_2^2}{2\sigma^2}\right)^{p-1/2}\right]\right\}\,\delta t\\
