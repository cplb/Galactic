...
\end{align}
the former piece still contains the logarithmic term which we know must be large. It is therefore the dominant piece of the integral and we neglect the latter~\citep{Chadrasekhar1941},
\begin{equation}
...
\end{equation}
This may be further simplified, reusing the limit of large $q$~\citep{Chadrasekhar1941,Chandrasekhar1941b},
\begin{align}
...
\dfrac{v_2^2}{v_1}\ln\left(\dfrac{v_1 + v_2}{v_2 - v_1}\right) + \dfrac{v_1^2}{v_2}\left[\ln qv_2^2 + \ln\left(1 - \dfrac{v_1^2}{v_2^2}\right)\right] & v_1 < v_2 \\
v_2\left(\ln qv_2^2 + \ln 4\right) & v_1 = v_2\\
\dfrac{v_1^2}{v_2}\ln\left(\dfrac{v_1 + v_2}{v_1 - v_2}\right) + \dfrac{v_2^2}{v_1}\left[\ln qv_2^2 + \ln\left(\dfrac{v_1^2}{v_2^2} - 1\right)\right] & v_1 > v_2
\end{cases} \\
\approx {} & \frac{8}{3}\begin{cases}
\dfrac{v_1^2}{v_2}\ln qv_2^2 & v_1 \leq v_2 \\
\dfrac{v_2^2}{v_1}\ln qv_2^2 & v_1 \geq v_2
\end{cases}.
\end{align}
This form maintains the correct limit for $v_2 \rightarrow 0$. We are left with
\begin{equation}
\Delta E^2(v_1) \approx \frac{8\pi}{3} n(v_1)G^2m_1^2 m_2^2\ln qv_2^2\begin{Bmatrix}\dfrac{v_1^2}{v_2} & v_1 \leq v_2\\ \dfrac{v_2^2}{v_1} & v_1 \geq v_2 \end{Bmatrix}\,\dd v_1\delta t.
\end{equation}
...
\dfrac{\Gamma(3 - p_M)\Gamma(1 + p_M)}{2} & \dfrac{v^2}{2\sigma^2} \geq 1
\end{cases},
\end{equation}
...
\dfrac{3}{(1 + p)(2 - p)} - \dfrac{9}{5(3-p)}\dfrac{v_2^2}{2\sigma^2} + \dfrac{9p}{14(7-p)}\left(\dfrac{v_2^2}{2\sigma^2}\right)^2 + \dfrac{p(1-p)}{6(5-p)}\left(\dfrac{v_2^2}{2\sigma^2}\right)^3 & \dfrac{v_2^2}{2\sigma^2} < 1 \\
\recip{1 - 2p}\left(\dfrac{v_2^2}{2\sigma^2}\right)^{-1/2}\left[\dfrac{9\sqrt{\pi}\Gamma(1+p)}{2\Gamma(p + 7/2)} - \dfrac{3\Gamma(3 - p)\Gamma(1 + p)}{2(2-p)}\left(\dfrac{v_2^2}{2\sigma^2}\right)^{p-1/2}\right] & \dfrac{v_2^2}{2\sigma^2} > 1\end{Bmatrix}\,\delta t.
\end{align}
...
\begin{equation}
\Delta E_u^2 \approx 16\sqrt{2\pi}G^2m_1^2m_2^2n_\ast\sigma\ln qv_2^2 C \Xi\frac{v_2^2}{2\sigma^2}\left[\Xi^2 + \left(\frac{v_2^2}{2\sigma^2}\right)^3\right]^{-1/2}\,\delta t,
\end{equation}
...
\begin{equation}
\Delta E^2 \approx \sum_M 16\sqrt{2\pi}G^2m_M^2m_2^2n_\ast\sigma\ln qv_2^2 \left\{k_M \beta\left(\frac{v_2^2}{2\sigma^2};p_M\right) + C_M\Xi\frac{v_2^2}{2\sigma^2}\left[\Xi^2 + \left(\frac{v_2^2}{2\sigma^2}\right)^3\right]^{-1/2}\right\}\,\delta t.
\end{equation}
...
\tau\sub{R} = {} & \left(\frac{m_2v_2^2}{2}\right)^2\frac{\delta t}{\Delta E^2} \\
 \approx {} & \frac{v_2^4}{16\sqrt{2\pi}G^2n_\ast\sigma\ln qv_2^2} \left(\sum_M m_M^2 \left\{k_M \beta\left(\frac{v_2^2}{2\sigma^2};p_M\right) + C_M\Xi\frac{v_2^2}{2\sigma^2}\left[\Xi^2 + \left(\frac{v_2^2}{2\sigma^2}\right)^3\right]^{-1/2}\right\}\right)^{-1}.
\end{align}
